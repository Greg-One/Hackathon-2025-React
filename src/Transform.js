        ...
        <section className='transform'>
          ...
          <nav className='transform__poem-actions'>
            ...
            <div className='transform__translation-controls'>
              <button className='transform__poem-navigation' onClick={prevPoem}>
                <svg
                  width='24'
                  height='24'
                  viewBox='0 0 24 24'
              ...
              <button className='transform__poem-navigation' onClick={randPoem}>
                <svg
                  width='24'
                  height='24'
                  viewBox='0 0 24 24'
              ...
              <button className='transform__poem-navigation' onClick={nextPoem}>
                <svg
                  width='24'
                  height='24'
                  viewBox='0 0 24 24'
